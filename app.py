...
HEROKU="https://chatoos.herokuapp.com"
...
ROOM_ID = "66e69679c047639f2ddc88a5"
ROOM_NAME = 'Chatoosites Room :)'
ADDED_BY = 'aakarsh2504@gmail.com'
...
def callback():
    ...
    try:
        ...
        return redirect(LOCAL+"/?user=new")
        ...
        if getattr(i,'notification_status')=="true":
            ...
            try:
                ...
                webpush(
                    ...
                    data=str({"title": mem["room_name"],"sender":data['name'],"body": data["message"],"link":LOCAL+"/rooms/{}".format(data['room'])}),
