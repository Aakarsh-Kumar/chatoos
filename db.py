...
# client = MongoClient("mongodb+srv://main:test@cluster0.yf3de1h.mongodb.net/chatoosDB?retryWrites=true&w=majority")
client = MongoClient("mongodb+srv://main1:test@cluster0.yf3de1h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
def update_user_notification_status(username,status,token):
    return users_collection.update_one({'_id':username},{'$set':{'notification-status':status,'notification-token':token}})
